...
protected:
    ...
    int16_t autofric[4] = {6996, 6936, 6325, 6381};
    //int16_t autofric[4]={4500,4500,4500,4500};
    int16_t Fric_Speed_High = autofric[Actual_Launch_Cnt]; // rpm
    int16_t Fric_Speed_Low = autofric[Actual_Launch_Cnt];  // rpm
...
#define PUSH_ROUND_TO_LENGTH 2e-3f // 输出轴一圈对应的丝杆行程 单位m
