...
void Class_Yaw_Motor::TIM_PID_PeriodElapsedCallback()
{
    ...
    case (DJI_Motor_Control_Method_ANGLE):
    {
        ...
        // Yaw_Target_Encoder=PID_Image.Get_Out();
        PID_Angle.Set_Target(Yaw_Target_Encoder);
        PID_Angle.Set_Now((Data.Now_Angle-Calibration_Angle)/360*8192);
...
{
    Yaw_Now_Angle = (Get_Now_Angle()-Calibration_Angle)*YAW_GEAR_RATIO;
}
